...
public class AcceptedApplicationsAdapter  extends RecyclerView.Adapter<AcceptedApplicationsAdapter.MyViewHolder>{


    ArrayList<ApplicationData> list;

    public AcceptedApplicationsAdapter(ArrayList<ApplicationData> list) {
        this.list = list;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AcceptedApplicationsAdapter.MyViewHolder(view);
    }
