...
public class PendingApplicationsAdapter  extends RecyclerView.Adapter<PendingApplicationsAdapter.MyViewHolder>{

    ArrayList<ApplicationData> list;

    public PendingApplicationsAdapter(ArrayList<ApplicationData> list) {
        this.list = list;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PendingApplicationsAdapter.MyViewHolder(view);
    }
