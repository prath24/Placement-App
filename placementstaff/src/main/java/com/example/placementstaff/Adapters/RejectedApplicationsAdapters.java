...
import com.example.placementstaff.ViewApplicationDetails;
import com.google.android.material.floatingactionbutton.FloatingActionButton;

import java.util.ArrayList;

public class RejectedApplicationsAdapters extends RecyclerView.Adapter<RejectedApplicationsAdapters.MyViewHolder> {

    ArrayList<ApplicationData> list;

    public RejectedApplicationsAdapters(ArrayList<ApplicationData> list) {
        this.list = list;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_hold_application,parent,false);
        return new RejectedApplicationsAdapters.MyViewHolder(view);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        TextView student,company,job,response;
